    ...
    try:
        ...
        if binary_result == 1:
            ...
            result = {
                ...
                "details": {
                    "offensive": True,
                    "offensive_reasons": [f"Following words might be offensive: {format_offensive_words(offensive_words)}"],
            ...
            if len(offensive_words) > 0:
                result["details"]["offensive_reasons"] = [f"Following words might be offensive: {format_offensive_words(offensive_words)}"]
